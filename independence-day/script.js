...
function share(e){
	const msg = `https://wa.me/?text=🇮🇳 ${languageJson[language].msg} 🇮🇳 %0a ${window.location.origin}/independence-day/?name=${encodeName(userInput.value)}${encodeURIComponent('&')}lang=${language}`;
	e.target.href = msg;
}